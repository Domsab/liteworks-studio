<template>
    <header class="bg-gray-900">
        ...
        >
            ...
            <div class="flex flex-1 justify-end">
                <div class="hidden lg:flex lg:gap-x-12">
                    <a
                        v-for="item in right_navigation"
                        :key="item.name"
                        :href="item.href"
                        class="text-sm font-semibold leading-6 text-gray-100"
                        >{{ item.name }}</a
            ...
            >
                <div class="flex items-center justify-between">
                    ...
                    <Link href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">liteWORKS Studio</span>
                        <img
                            class="h-8 w-auto"
    ...
    <div class="w-fullbg-white overflow-hidden">
        <slot />
    </div>
    <!--
    ...
    <footer class="bg-white">
        <div class="mx-auto max-w-7xl py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
            <div class="flex justify-center space-x-6 md:order-2">
                <a v-for="item in footer_navigation" :key="item.name" :href="item.href" class="text-gray-400 hover:text-gray-500">
